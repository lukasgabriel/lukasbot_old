...
def get_urban_definition(term):
    ...
    if response.status_code == 200:
        ...
        raise lh.APIError(code=response.status_code, url=f'http://urbanscraper.herokuapp.com/define/{term}', headers=response.headers, msg=response.reason, text=response.text)
